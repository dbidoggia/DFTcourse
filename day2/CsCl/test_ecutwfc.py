...
/
&SYSTEM
  ecutrho =   {x*8}   !typically 4 times ecutwfc for norm-conserving, 8 for ultrasoft pseudos (we are using ultrasoft (uspp in the name of psedos)) 
  ecutwfc =   {x}     !cutoff energy for wavefunctions (in Ry)
  ibrav = 1           !cubic
